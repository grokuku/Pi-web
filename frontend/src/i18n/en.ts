  ...
  settings: {
    ...
    general: {
      ...
      concurrency: {
        ...
        perProviderHint: "Leave empty = inherit from the global default (LLM slots max). You can add a provider missing from the list.",
        provider: "Provider",
        inherit: "inherits",
        noProviders: "No provider configured.",
        addProvider: "Add",
        addProviderPlaceholder: "Provider id",
