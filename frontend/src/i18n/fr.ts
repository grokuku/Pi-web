  ...
  settings: {
    ...
    general: {
      ...
      concurrency: {
        ...
        perProviderHint: "Laisser vide = hériter du défaut global (LLM slots max). Vous pouvez ajouter un provider absent de la liste.",
        provider: "Provider",
        inherit: "hérite",
        noProviders: "Aucun provider configuré.",
        addProvider: "Ajouter",
        addProviderPlaceholder: "Identifiant du provider",
