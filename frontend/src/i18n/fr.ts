...
export const fr = {
  ...
  settings: {
    ...
    general: {
      ...
      concurrency: {
        ...
        silenceTimeout: "Délai de silence de flux (minutes)",
        silenceTimeoutHint: "Un run n'est arrêté qu'après ce délai SANS aucun événement streamé. Chaque événement réinitialise le compteur → une génération de plusieurs heures n'est jamais coupée. 0 = illimité. Défaut : 15 min.",
        hardTimeout: "Garde-fou de dernier recours (minutes)",
        hardTimeoutHint: "Plafond de durée totale, optionnel. Laisser à 0 (désactivé) pour ne jamais couper un long travail par sa durée. Défaut : 0.",
        save: "ENREGISTRER",
        perProviderMoved: "Le nombre d'appels simultanés par fournisseur se règle dans la fiche de chaque fournisseur (Bibliothèque de modèles → Fournisseurs). Défaut : 3.",
        usageByProvider: "Utilisation par provider",
        usageEmpty: "Aucune activité LLM.",
  ...
  modelSwitch: {
    ...
    thinkingByModel: "Niveau de réflexion par défaut pour ce modèle",
    thinkingDefault: "— Défaut —",
  },
  ...
  modelLibrary: {
    ...
    baseUrl: "URL DE BASE",
    apiKey: "CLÉ API",
    maxConcurrentCalls: "APPELS SIMULTANÉS",
    maxConcurrentCallsHelp: "Nombre d'appels LLM menés en parallèle vers ce fournisseur ; les appels en trop attendent leur tour. Défaut : 3.",
    maxConcurrentCallsError: (max: number) => `Entrez un entier entre 1 et ${max}.`,
